...
<head>
	...
	<title>SIGEP - Sistema de Gesti�n del Programa SUMAR - Plan Nacer. Chaco</title>
	...
	<div>
		...
		<div class="main-header">
			<div class="logos">
				...
				<img src="<?echo $newstyles_path?>/images/msal-logo.png" alt="Ministerio de Salud de la Naci�n" /> 
			</div>
			
			<div class="title">
				<h1>SIGEP</h1>
				<p>Sistema de Gesti�n. Programa SUMAR.</p>
			...
			<div class="user-info">
				...
				<p><a href="<?=$onclick?>"><i class="icon-off"></i> Cerrar Sesi�n</a></p>
			</div>
		</div>
		...
		<?
			if ($parametros['mode'] == "debug") {  
				//es porque seleccion� el debugger y tiene que mantener la pagina
				//echo "GET= ".$_GET['menu'];
