...
<table class="table table-condensed table-hover table-striped">
	...
	<thead>
		<tr>
			...
			<th><a id=mo href='<?=encode_link("errores_nombreyapellido.php",array("sort"=>"6","up"=>$up))?>'>Inscripción</a></th> 				
			<th><a id=mo href='<?=encode_link("errores_nombreyapellido.php",array("sort"=>"7","up"=>$up))?>'>Activo</a></th> 							
			<th><a id=mo href='<?=encode_link("errores_nombreyapellido.php",array("sort"=>"8","up"=>$up))?>'>Código</a></th> 				
