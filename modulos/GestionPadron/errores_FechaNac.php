...
variables_form_busqueda("errores_FechaNac");
...
<form name=form1 action="errores_nombreyapellido.php" method=POST>
	...
	<div class="row-fluid">
		...
		<div class="span4">
			<? $link=encode_link("errores_FechaNac_excel.php",array());?>
...
<div class="pull-right paginador">
	<?=$total_muletos?> Errores en fecha de nacimiento encontrados. 
	<?=$link_pagina?>
</div> 
...
<table class="table table-condensed table-hover table-striped">
	...
	<thead>
		<tr>
			<th><a id=mo href='<?=encode_link("errores_FechaNac.php",array("sort"=>"1","up"=>$up))?>'>Clave</a></th>
			<th><a id=mo href='<?=encode_link("errores_FechaNac.php",array("sort"=>"2","up"=>$up))?>'>DNI</a></th>
			<th><a id=mo href='<?=encode_link("errores_FechaNac.php",array("sort"=>"3","up"=>$up))?>'>Apellido</a></th>
			<th><a id=mo href='<?=encode_link("errores_FechaNac.php",array("sort"=>"4","up"=>$up))?>'>Nombre</a></th>
			<th><a id=mo href='<?=encode_link("errores_FechaNac.php",array("sort"=>"5","up"=>$up))?>'>Nacimiento</a></th>
			<th><a id=mo href='<?=encode_link("errores_FechaNac.php",array("sort"=>"6","up"=>$up))?>'>Inscripción</a></th> 				
			<th><a id=mo href='<?=encode_link("errores_FechaNac.php",array("sort"=>"7","up"=>$up))?>'>Activo</a></th> 							
			<th><a id=mo href='<?=encode_link("errores_FechaNac.php",array("sort"=>"8","up"=>$up))?>'>Código</a></th> 				
			<th><a id=mo href='<?=encode_link("errores_FechaNac.php",array("sort"=>"9","up"=>$up))?>'>Efector</a></th> 							
		</tr>
	</thead>
