...
<script>
	...
	function getRCVG() {
		...
		var hta = document.all.hta.value;
...
<form name='form1' action='ins_admin.php' accept-charset="utf-8" method='POST'>
	...
	<?
	$query2 = "SELECT cast(cast(MAX(PERIODO)|| '01' as date) + interval '1 month' as date) periodo FROM nacer.smiprocesoafiliados";
	...
	<div id="redes" style="display:<?= $redes ?>;" >
		...
		<div class="row-fluid">
			...
			<div class="span2">
				<label>HTA:</label>
				<input type="text" size="10" value='<?=$hta?>' name="hta" id="hta" onchange="handleClick(this);"
				<?php if (($id_planilla) and ($tipo_transaccion != "M"))echo "disabled"?>>
			</div>			
		</div>
