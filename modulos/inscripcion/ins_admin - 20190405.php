	...
	<div id="redes" style="display:<?= $redes ?>;">
		...
		<div class="row-fluid">
			...
			<div class="span2">
				...
				<label class="radio">
					<input type="radio" name="estatinas" value="S" onclick="document.all.estatinas[1].checked=false" <?php if (($id_planilla) and ($tipo_transaccion != "M"))echo "disabled"?> <?php if($estatinas == "S") echo "checked" ;?> > SI
				</label>
				<label class="radio">
					<input type="radio" name="estatinas" value="N" onclick="document.all.estatinas[0].checked=false;" <?php if (($id_planilla) and ($tipo_transaccion != "M"))echo "disabled"?> <?php if($estatinas == "N") echo "checked" ;?> > NO
				</label>
			</div>
		</div>
	</div>
